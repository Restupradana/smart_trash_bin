                            ...
                            <li class="border p-4 rounded bg-gray-50 dark:bg-gray-700">
                                ...
                                <p class="text-sm mt-2">
                                    ...
                                    <span class="px-2 py-1 rounded text-white
                                        ...
                                        {{ $notif->status === 'pending' ? 'Pending' : 'Dikonfirmasi' }}
                                    </span>
                                </p>

                                {{-- Tombol Konfirmasi atau Edit --}}
                                <a href="{{ route('petugas.konfirmasi.form', ['id' => $notif->id]) }}"
                                    class="mt-3 inline-block px-4 py-2 
                                    {{ $notif->status === 'pending' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-600 hover:bg-gray-700' }}
